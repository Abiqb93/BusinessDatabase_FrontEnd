    ...
    <Card className="shadow border-0">
      <CardBody>
        <Table responsive className="align-items-center">
          <thead>
            <tr>
              {["Jockey", "Country", "Runners", "Runs", "Winners", "Wins", "WinPercent_", "Stakes_Winners", "Stakes_Wins", "Group_Winners", "Group_Wins", "Group_1_Winners", "Group_1_Wins", "WTR", "SWTR", "GWTR", "G1WTR", "WIV", "WOE", "WAX", "Percent_RB2"].map(
                (el) => (
...
const JockeyProfile = () => {
  ...
  const [selectedTable, setSelectedTable] = useState("jockey_name_profile");
            ...
            <Card className="shadow border-0 p-4">
              <div className="mt-12 mb-8 flex flex-col gap-8">
                ...
                <div className="flex items-center mb-3">
                  ...
                  >
                    <option value="jockey_name_profile">Overall</option>
                    <option value="jockey_name_profile_three">Last 3 Years</option>
                    <option value="jockey_name_profile_one">Last 1 Year</option>
                  </select>
                </div>
